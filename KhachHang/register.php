...
<?php
    ...
    && isset($_POST['sdt']) && isset($_POST['add']))
    {
        ...
        if (empty($first_name)) {
            ...
            $result = register($user,$pass,$first_name,$last_name, $add,$email, $sdt);
            if(!$result['code'] == 0) {
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 border my-5 p-4 rounded mx-3">
                ...
                <form method="post" action="" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input  value="<?= $add?>" name="add" required class="form-control" type="text" placeholder="Address" id="add">
                        <div class="invalid-feedback">Password is not valid.</div>
                    </div>
                    <div class="form-group">
                        <label for="std">SDT</label>
                        <input  value="<?= $sdt?>" name="sdt" required class="form-control" type="text" placeholder="SDT" id="std">
                        <div class="invalid-feedback">Password is not valid.</div>
                    </div>
